...
typedef int8_t (*pfn_i2c_read)(uint8_t slave_addr, uint8_t reg_addr, uint8_t *p_data, uint8_t nbytes);
typedef int8_t (*pfn_i2c_write)(uint8_t slave_addr, uint8_t reg_addr, uint8_t *p_data, uint8_t nbytes);
